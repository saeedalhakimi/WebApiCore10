...
namespace WebApiCore10.RustApi.Application.Services.AuthHandlingServices
{
    public class AuthHandlingService : IAuthHandlingService
    {
        ...
        public AuthHandlingService(ILogger<AuthHandlingService> logger, IErrorHandlingService errorHandlingService, DataContext dataContext, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, IJwtService jwtService)
        {
            _logger = logger;
